...
export default function Hero({ currentTrack, isPlaying, onTogglePlay, onSelectTrack }) {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-32 sm:pt-36 pb-20 overflow-hidden">
      {/* Background Graphic & Glows */}
      <div className="absolute inset-0 bg-[#050506] -z-20"></div>
      
      {/* Neon Cyan Radial Aura */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] bg-cyan-500/15 rounded-full blur-[140px] pointer-events-none -z-10 animate-pulse-glow"></div>
      <div className="absolute bottom-10 right-10 w-[400px] h-[400px] bg-blue-900/20 rounded-full blur-[120px] pointer-events-none -z-10"></div>
      ...
      <div className="container-custom relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center min-h-[80vh]">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span className="tag-badge">
                ...
                <span>CAMPEONA DE FREESTYLE</span>
              </span>
              ...
              <span className="px-3 py-1 rounded-full bg-cyan-950/40 border border-cyan-800/40 text-[11px] font-tech font-semibold text-cyan-300">
                🎙️ DUETOS & FREESTYLE
              </span>
            </div>
            ...
            <div className="space-y-1">
              <p className="text-xs sm:text-sm font-tech uppercase tracking-[0.35em] text-[#00f0ff] font-bold">
              ...
              <h1 className="font-heading text-6xl sm:text-7xl md:text-8xl lg:text-9xl text-white tracking-wider leading-none select-none">
                CORE<span className="text-[#00f0ff] drop-shadow-[0_0_25px_rgba(0,240,255,0.7)]">BACK</span>
              </h1>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 w-full max-w-md border-t border-zinc-800/80">
              ...
              <div>
                <div className="font-heading text-3xl sm:text-4xl text-[#00f0ff]">1º LUGAR</div>
                <div className="text-[11px] font-tech text-zinc-400 uppercase tracking-wider">Batallas de Freestyle</div>
              </div>
              <div>
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            ...
            {/* Visual Frame */}
            <div className="relative w-full max-w-md rounded-2xl p-2 bg-gradient-to-b from-cyan-500/30 via-zinc-900/40 to-black border border-cyan-500/40 shadow-[0_0_50px_rgba(0,240,255,0.25)] group">
              
              {/* Corner Accents */}
              <div className="absolute -top-1.5 -left-1.5 w-4 h-4 border-t-2 border-l-2 border-[#00f0ff]"></div>
              <div className="absolute -top-1.5 -right-1.5 w-4 h-4 border-t-2 border-r-2 border-[#00f0ff]"></div>
              <div className="absolute -bottom-1.5 -left-1.5 w-4 h-4 border-b-2 border-l-2 border-[#00f0ff]"></div>
              <div className="absolute -bottom-1.5 -right-1.5 w-4 h-4 border-b-2 border-r-2 border-[#00f0ff]"></div>
              ...
              <div className="relative aspect-[3/4] rounded-xl overflow-hidden bg-zinc-950">
                ...
                {/* Top Badge Overlay */}
                <div className="absolute top-4 left-4 flex items-center gap-2 bg-black/70 backdrop-blur-md px-3 py-1.5 rounded-full border border-cyan-500/40">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-black/85 backdrop-blur-md p-4 rounded-xl border border-white/10 space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-[10px] font-tech uppercase text-[#00f0ff] font-bold tracking-wider">
                        TRACK DESTACADO
                      </span>
                    ...
                    <button
                      onClick={onTogglePlay}
                      className="w-10 h-10 rounded-full bg-[#00f0ff] text-black flex items-center justify-center hover:bg-cyan-400 transition-all hover:scale-110 shadow-lg shadow-cyan-500/40"
                  ...
                  <div className="flex items-center gap-1 h-4 pt-1">
                    {[40, 75, 90, 50, 85, 100, 60, 80, 45, 95, 70, 85, 60, 40, 90, 65, 30].map((h, i) => (
                      <span
                        key={i}
                        className="flex-1 bg-gradient-to-t from-[#00f0ff] to-blue-400 rounded-full transition-all duration-150"
                        style={{
        ...
        <div className="flex justify-center pt-8">
          <a
            href="#about"
            className="flex flex-col items-center gap-2 text-zinc-500 hover:text-[#00f0ff] transition-colors"
          >
            <span className="text-[10px] font-tech uppercase tracking-[0.25em]">CONOCE LA HISTORIA</span>
            <ArrowDown size={16} className="animate-bounce text-[#00f0ff]" />
          </a>
        </div>

      </div>

      {/* Bottom Neon Laser Line */}
      <div className="absolute bottom-0 left-0 right-0 neon-laser-line"></div>
    </section>
  );
}
